    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bus", x => new { x.License, x.Region });
                    table.ForeignKey(
                        name: "FK_Bus_Engines_EngineId",
                        column: x => x.EngineId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomEngineId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecialCar", x => x.CarId);
                    table.ForeignKey(
                        name: "FK_SpecialCar_Engines_CustomEngineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_Towns_CurrentResidenceId",
                        column: x => x.CurrentResidenceId,
                        principalTable: "Towns",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Students_Towns_PlaceOfBirthId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialCar_CustomEngineId",
                schema: "customSchema",
                table: "SpecialCar",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_CurrentResidenceId",
                table: "Students",
                column: "CurrentResidenceId");

            migrationBuilder.CreateIndex(
                name: "IX_Students_PlaceOfBirthId",
                table: "Students",
